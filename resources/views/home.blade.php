            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="image-layer"
                         style="background-image: url(assets/images/backgrounds/cavendish.png);"></div>
                    <!-- /.image-layer -->
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-8">
                                <div class="main-slider__content">
                                    <p class="main-slider__sub-title">Budi daya pisang Cavendish</p>
                                    <h2 class="main-slider__title">Optimalkan Wakaf dengan Investasi</h2>
                                    <div class="main-slider__btn-box">
                                        <a href="about.html" class="thm-btn main-slider__btn"> Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="image-layer"
                         style="background-image: url(assets/images/backgrounds/khutbah.png);"></div>
                    <!-- /.image-layer -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-8">
                                <div class="main-slider__content">
                                    <p class="main-slider__sub-title">Pelatihan khutbah Jum'at</p>
                                    <h2 class="main-slider__title">Agar Khutbah Memukau dan Sesuai Syar'i</h2>
                                    <div class="main-slider__btn-box">
                                        <a href="about.html" class="thm-btn main-slider__btn"> Detail</a>
                                    </div>
                                </div>
                ...
                <div class="swiper-slide">
                    <div class="image-layer"
                         style="background-image: url(assets/images/backgrounds/mushaf.png);"></div>
                    <!-- /.image-layer -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-8">
                                <div class="main-slider__content">
                                    <p class="main-slider__sub-title">Wakaf mushaf untuk penuntuk ilmu</p>
                                    <h2 class="main-slider__title">Untuk Generasi Pengemban Qur'an</h2>
                                    <div class="main-slider__btn-box">
                                        <a href="about.html" class="thm-btn main-slider__btn"> Detail</a>
                                    </div>
                                </div>
                            ...
                            <div class="about-one__curved-circle-box">
                                <div class="curved-circle">
                                        <span class="curved-circle--item">
                                            15 TAHUN PENGALAMAN DALAM SOSIAL DAKWAH PENDIDIKAN
                                        </span>
                                </div><!-- /.curved-circle -->
                ...
                <div class="col-xl-6">
                    <div class="about-one__right">
                        <div class="section-title text-left">
                            <span class="section-title__tagline">Selamat datang di iSalam Wakaf</span>
                            <h2 class="section-title__title">Memaksimalkan hasil dan pahala wakaf Anda</h2>
                        </div>
                        <p class="about-one__text">Kita sering terpaku pada wakaf mati seperti tanah, bangunan dan barang mati yang akan tergerus oleh umur dan bergantun kepada penggunaan wakaf tersebut.
                            iSalam memaksimalkan pahala Anda dengan wakaf produktif yang cukup wakaf sedikit tapi akan berkembang menjadi besar dengan manfaat yang berlipat dan kegunaan dalam jangka yang sangat lama.</p>
                        <div class="about-one__fund">
                            <p class="about-one__fund-text">Kami telah membuat <span>30</span> proyek wakaf di
                                <span>24</span> provinsi, dan memberikan manfaat kepada <span>10</span> juta orang.</p>
                        </div>
                        <ul class="list-unstyled about-one__points">
                            <li>
                                ...
                                <div class="text">
                                    <h5><a href="become-volunteer.html">Menjadi relawan</a></h5>
                                    <p>Kami arahkan Anda untuk ikut dalam program kebaikan bersama iSalam.</p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <h5><a href="donate-now.html">Mulai Wakaf</a></h5>
                                    <p>Pilih program wakaf kami dan berwakaf untuk tabungan akhirat Anda.</p>
                                </div>
                            </li>
                        </ul>
                        <a href="about.html" class="thm-btn about-one__btn">Lebih lanjut</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="causes-one">
        <div class="container">
            <div class="section-title text-center">
                <span class="section-title__tagline">Berwakaf bersama iSalam</span>
                <h2 class="section-title__title">Pilih progam wakaf yang sesuai <br> dan infak di jalan Allah</h2>
            </div>
            <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="causes-one__single">
                            ...
                            <div class="causes-one__content">
                                ...
                                <p class="causes-one__text">{{$project->description}}</p>
                                <div class="causes-one__progress">
                                    <div class="causes-one__progress-shape"
                                         style="background-image: url({{$project->picture_url}});">
                                    </div>
                                    <div class="bar">
                                        <div class="bar-inner count-bar" data-percent="{{$project->percentage_amount_collected}}%">
                                            <div class="count-text">{{$project->percentage_amount_collected == 0 ? "0" : $project->percentage_amount_collected}}%</div>
                                        </div>
                                    </div>
                                    <div class="causes-one__goals">
                                        <p><span>Rp. {{$project->amount_collected == 0 ? "0" : $project->amount_collected}}</span></p>
                                        <p><span>Rp. {{$project->target_amount == 0 ? "0" : number_format($project->target_amount, 0, 0, ".")}}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
